...
public class ClienteMain {
    ...
    public static  void alterarClienteCadastrado(List<Pessoa> listaDeClientes, Scanner sc) {
        ...
        String CPFCNPJClienteParaAlterar = sc.nextLine();
        Pessoa alterarCliente = null;
        for (Pessoa cliente : listaDeClientes) {
            if (cliente instanceof PessoaFisica && ((PessoaFisica) cliente).getCPF().equals(CPFCNPJClienteParaAlterar)) {
                alterarCliente = cliente;
                break;
            } else if (cliente instanceof PessoaJuridica && ((PessoaJuridica) cliente).getCNPJ().equals(CPFCNPJClienteParaAlterar)) {
                alterarCliente = cliente;
                break;
            }
        }
